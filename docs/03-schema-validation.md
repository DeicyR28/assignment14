...
class CalculationBase(BaseSchema):
    ...
    type: str = Field(..., description="Type of calculation: addition, subtraction, multiplication, division, exponentiation")
    ...
    def validate_calculation_type(cls, v):
        ...
        valid_types = ['addition', 'subtraction', 'multiplication', 'division', 'exponentiation']
